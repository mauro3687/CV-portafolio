...
const ChatPortfolio = () => {
  ...
  const t = {
    es: {
      ...
      placeholder: "Preguntar a Mauro_IA",
      disclaimer: "Mauro_IA es una IA interactiva basada en React.",
      ...
      respGreetings: "¡Hola! Qué bueno verte por acá. Soy Mauro_IA. ¿En qué te puedo ayudar hoy? Podés elegir una opción o preguntarme directamente.",
      ...
      respSkillsDev: "Acá tenés mi stack tecnológico enfocado en desarrollo de software y metodologías:",
      ...
      respExperienceDev: "Tengo +2 años de experiencia. Trabajo en el **Ministerio de Salud**, optimizando la carga de datos y sistemas provinciales, además de proyectos freelance.",
      ...
      spamWarning: "⚠️ Límite de seguridad: Para evitar spam, solo se permite abrir el correo 2 veces por semana. Por favor, contactame por LinkedIn o WhatsApp si es urgente.",
    ...
    en: {
      ...
      placeholder: "Ask Mauro_IA",
      disclaimer: "Mauro_IA is an interactive AI based on React.",
      settings: "Settings",
      language: "Language",
      ...
      respGreetings: "Hello! Great to see you here. I'm Mauro_IA. How can I help you today?",
      ...
      respSkillsDev: "Here is my tech stack focused on software development and methodologies:",
      ...
      spamWarning: "⚠️ Security limit: To prevent spam, opening the email client is limited to 2 times per week. Please reach me on LinkedIn or WhatsApp if it's urgent.",
  ...
  // ==========================================
  // FUNCIÓN ANTI-SPAM PARA EL EMAIL
  // ==========================================
  const handleEmailClick = (e, url) => {
    ...
    if (now - emailData.firstSentDate > WEEK_IN_MS) {
      emailData = { count: 0, firstSentDate: now };
    }
  ...
  const generateResponse = (input) => {
    ...
    if (text.includes('habilidad') || text.includes('tecnologia') || text.includes('stack') || text.includes('skill') || text.includes('herramienta') || text.includes('telecom') || text.includes('agil')) {
      return {
    ...
    if (text.includes('tancat') || text.includes('proyecto') || text.includes('project') || text.includes('portfolio') || text.includes('demo')) {
      return {
        ...
        projects: [
          ...
          {
            id: 'p2', title: 'Mauro_IA UI Clone',
            description: lang === 'es' ? 'Interfaz conversacional estilo Mauro_IA. Motor interactivo en React.' : 'Mauro_IA style conversational interface. Interactive React engine.',
                            ...
                            if (link.id === 'email') {
                              return (
                                <button 
                                  ...
                                  className={`card-popup flex items-center gap-3 px-5 py-3 rounded-2xl bg-[#1e1f20] border border-[#333537] transition-all duration-300 hover:-translate-y-2 ${link.color}`}
